...
class CosmeticsManager
    ...
    CosmeticsManager ( ) {
        ...
        this.cosmeticsUserMap.put ( "bd93bbcb-4dc4-44c6-bd7e-139f12c674b8" , Arrays.asList ( new ModelBase[]{Cosmetics.INSTANCE.cloutGoggles} ) );
        ...
        this.cosmeticsUserMap.put ( "bd93bbcb-4dc4-44c6-bd7e-139f12c674b8" , Arrays.asList ( new ModelBase[]{Cosmetics.INSTANCE.squidLauncher} ) );
        ...
        this.cosmeticsUserMap.put ( "bd93bbcb-4dc4-44c6-bd7e-139f12c674b8" , Arrays.asList ( Cosmetics.INSTANCE.glassesModel , Cosmetics.INSTANCE.squidLauncher ) );

...
class MathUtil
    ...
    public static
    double angleBetweenVecs ( Vec3d vec3d , Vec3d other ) {
    ...
    public static
    double getIncremental ( double val , double inc ) {
        double one = 1.0 / inc;
    ...
    public static
    double[] differentDirectionSpeed ( double speed ) {

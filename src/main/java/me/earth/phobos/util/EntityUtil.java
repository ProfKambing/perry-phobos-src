...
class EntityUtil implements Util {
    ...
    public static
    boolean isPassive ( final Entity entity ) {
    ...
    public static
    boolean isMobAggressive ( final Entity entity ) {
    ...
    public static
    boolean isNeutralMob ( final Entity entity ) {
        return entity instanceof EntityPigZombie || entity instanceof EntityWolf || entity instanceof EntityEnderman;
    }

    public static
    boolean isProjectile ( final Entity entity ) {
        return entity instanceof EntityShulkerBullet || entity instanceof EntityFireball;
    }

    public static
    boolean isVehicle ( final Entity entity ) {
    ...
    public static
    boolean isBlockValid ( final BlockPos blockPos ) {
    ...
    public static
    boolean isInWater ( final Entity entity ) {
        if ( entity == null ) {
            return false;
        }
    ...
    public static
    boolean isLiving ( final Entity entity ) {
        return entity instanceof EntityLivingBase;
    }

    public static
    boolean isAlive ( final Entity entity ) {
        return isLiving ( entity ) && ! entity.isDead && ( (EntityLivingBase) entity ).getHealth ( ) > 0.0f;
    }

    public static
    boolean isDead ( final Entity entity ) {
        return ! isAlive ( entity );
    }

    public static
    float getHealth ( final Entity entity ) {
        if ( isLiving ( entity ) ) {
    ...
    public static
    boolean holdingWeapon ( final EntityPlayer player ) {
    ...
    public static
    boolean holding32k ( final EntityPlayer player ) {
        return is32k ( player.getHeldItemMainhand ( ) );
    }

    public static
    boolean is32k ( final ItemStack stack ) {
        if ( stack == null ) {
            return false;
        }
    ...
    public static
    boolean isFakePlayer ( final EntityPlayer player ) {

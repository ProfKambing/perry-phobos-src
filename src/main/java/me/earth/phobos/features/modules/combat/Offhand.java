        ...
        if ( this.type.getValue ( ) == Type.NEW ) {
            ...
            if ( this.gapSwap.getValue ( ) ) {
                if ( ( this.getSlot ( Mode.GAPPLES ) != - 1 || Offhand.mc.player.getHeldItemOffhand ( ).getItem ( ) == Items.GOLDEN_APPLE ) && Offhand.mc.player.getHeldItemMainhand ( ).getItem ( ) != Items.GOLDEN_APPLE && Offhand.mc.gameSettings.keyBindUseItem.isKeyDown ( ) )
                    if ( ( this.getSlot ( Mode.GAPPLES ) != - 1 || Offhand.mc.player.getHeldItemOffhand ( ).getItem ( ) == Items.EXPERIENCE_BOTTLE ) && Offhand.mc.player.getHeldItemMainhand ( ).getItem ( ) != Items.EXPERIENCE_BOTTLE && Offhand.mc.gameSettings.keyBindUseItem.isKeyDown ( ) )
                        if ( ( this.getSlot ( Mode.GAPPLES ) != - 1 || Offhand.mc.player.getHeldItemOffhand ( ).getItem ( ) == Items.DIAMOND_PICKAXE ) && Offhand.mc.player.getHeldItemMainhand ( ).getItem ( ) != Items.DIAMOND_PICKAXE && Offhand.mc.gameSettings.keyBindUseItem.isKeyDown ( ) )
                            if ( ( this.getSlot ( Mode.GAPPLES ) != - 1 || Offhand.mc.player.getHeldItemOffhand ( ).getItem ( ) == Items.CHORUS_FRUIT ) && Offhand.mc.player.getHeldItemMainhand ( ).getItem ( ) != Items.CHORUS_FRUIT && Offhand.mc.gameSettings.keyBindUseItem.isKeyDown ( ) )

...
class Killaura
    ...
    void doKillaura ( ) {
        ...
        int wait = ! this.delay.getValue ( ) || EntityUtil.holding32k ( Killaura.mc.player ) && ! this.teekaydelay.getValue ( ) ? 0 : (int) ( (float) DamageUtil.getCooldownByWeapon ( Killaura.mc.player ) * ( this.tps.getValue ( ) ? Phobos.serverManager.getTpsFactor ( ) : 1.0f ) );

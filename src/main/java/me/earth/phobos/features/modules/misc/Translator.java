...
class Translator
        extends Module {
    private final Setting < Language > sourceLanguage = this.register ( new Setting <> ( "SourceLanguage" , Language.English ) );
    private final Setting < Language > targetLanguage = this.register ( new Setting <> ( "TargetLanguage" , Language.Spanish ) );
    ...
    private
    JsonObject request ( String URL2 ) throws IOException {
    ...
    class Translate
        ...
        public
        Translate ( String message , Language sourceLang , Language lang ) {
            super ( "Translate" );

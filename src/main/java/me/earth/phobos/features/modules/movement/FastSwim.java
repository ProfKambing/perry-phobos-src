...
class FastSwim
        extends Module {
    public Setting < Double > waterHorizontal = this.register ( new Setting <> ( "WaterHorizontal" , 3.0 , 1.0 , 20.0 ) );
    public Setting < Double > waterVertical = this.register ( new Setting <> ( "WaterVertical" , 3.0 , 1.0 , 20.0 ) );
    public Setting < Double > lavaHorizontal = this.register ( new Setting <> ( "LavaHorizontal" , 4.0 , 1.0 , 20.0 ) );
    public Setting < Double > lavaVertical = this.register ( new Setting <> ( "LavaVertical" , 4.0 , 1.0 , 20.0 ) );

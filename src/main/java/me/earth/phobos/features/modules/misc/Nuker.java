...
class Nuker
    ...
    private final Setting < Boolean > autoSwitch = this.register ( new Setting <> ( "AutoSwitch" , false ) );
    ...
    public Setting < Boolean > antiRegear = this.register ( new Setting <> ( "AntiRegear" , false ) );
    public Setting < Boolean > hopperNuker = this.register ( new Setting <> ( "HopperAura" , false ) );
    ...
    @SubscribeEvent
    public
    void onClickBlock ( BlockEvent event ) {
        Block block;
